		...
		<div ref={containerRef} className={`relative ${className}`}>
			...
			<button
				...
				className={`
					...
					flex items-center gap-2 shadow-sm hover:shadow-md focus:shadow-lg
					${
						disabled
								...
								return (
									<button
										...
										className={`
											...
											${
												isStart || isEnd
													? 'bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700 dark:from-primary-600 dark:via-primary-700 dark:to-primary-800 text-white shadow-md shadow-primary-500/30 dark:shadow-primary-600/30 hover:from-primary-600 hover:via-primary-700 hover:to-primary-800 font-bold'
													: inRange
													? 'bg-gradient-to-r from-primary-50 to-primary-100 dark:from-primary-900/30 dark:to-primary-800/20 text-primary-700 dark:text-primary-300'
													: today
